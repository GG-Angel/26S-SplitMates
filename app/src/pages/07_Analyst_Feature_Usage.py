...
if chores:
    ...
    <div style="background:white;border:1px solid #EAECF0;border-radius:12px;padding:1.25rem;box-shadow:0 1px 2px rgba(16,24,40,0.04);">
        ...
        <div style="font-size:0.8rem;color:#667085;margin-bottom:1rem;font-family:sans-serif;">
            <span style="display:inline-flex;align-items:center;gap:4px;margin-right:12px;"><span style="width:10px;height:10px;border-radius:2px;background:#fca5a5;display:inline-block;"></span>Low effort</span>
            ...
            <span style="display:inline-flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:2px;background:#7f1d1d;display:inline-block;"></span>High effort</span>
        </div>
