...
def _connect_to_database(max_attempts: int = 10, delay_seconds: int = 3):
    ...
    raise last_error if last_error is not None else RuntimeError("Unable to connect to database")
